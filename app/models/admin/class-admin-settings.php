<?php
namespace Order_Form\App\Models\Admin;

use Order_Form\App\Models\Settings as Settings_Model;
use Order_Form\App\Models\Admin\Base_Model;
...
if ( ! class_exists( __NAMESPACE__ . '\\' . 'Admin_Settings' ) ) {
	 ...
	 * @since      1.0.0
	 * @package    Order_Form
	 * @subpackage Order_Form/models/admin
	 */
