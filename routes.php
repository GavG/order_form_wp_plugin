...
|		>with_controller( 'Admin_Settings' ) // Resolved by Router to 'Order_Form\App\Controllers\Admin\Admin_Settings'.
|		->with_model( 'Admin_Settings' ) // Resolved by Router to 'Order_Form\App\Models\Admin\Admin_Settings'.
|		->with_view( 'Admin_Settings' ); // Resolved by Router to 'Order_Form\App\Views\Admin\Admin_Settings'.
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_controller( 'Order_Form\App\Controllers\Admin\Admin_Settings' )
|		->with_model( 'Order_Form\App\Models\Admin\Admin_Settings' )
|		->with_view( 'Order_Form\App\Views\Admin\Admin_Settings' );
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_just_model('Order_Form_Model_Admin_Settings');
|-------------------------------------------------------------------------------------------
*/
...
$router
	->register_route_of_type( ROUTE_TYPE::ADMIN )
	->with_controller( 'Admin_Settings@register_hook_callbacks' ) // Resolved by Router to 'Order_Form\App\Controllers\Admin\Admin_Settings'.
	->with_model( 'Admin_Settings' ) // Resolved by Router to 'Order_Form\App\Models\Admin\Admin_Settings'.
	->with_view( 'Admin_Settings' ); // Resolved by Router to 'Order_Form\App\Views\Admin\Admin_Settings'.
