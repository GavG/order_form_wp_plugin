<?php
use Order_Form\Includes\i18n;
use Order_Form\Includes\Dependency_Loader;
use Order_Form\Core\Registry\Controller as Controller_Registry;
use Order_Form\Core\Registry\Controller as Model_Registry;
use Order_Form\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'Order_Form' ) ) {
	 ...
	 */
	class Order_Form extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      Order_Form    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( Order_Form::PLUGIN_ID );
